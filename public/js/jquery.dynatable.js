...
(function($) {
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      var recordsShown = obj.records.count(),
          ...
          toText = settings.inputs.toText,
          fromText = settings.inputs.fromText,
          filtersText = settings.inputs.filtersText,
          totalRecordsText = settings.inputs.totalRecordsText,
          recordsText = settings.inputs.recordsText;

      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        var bounds = obj.records.pageBounds();
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " " + toText + " " + bounds[1] + "</span> " + fromText + " ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " de ";
      }
      text += recordsQueryCount + " " + recordsText;
      if (recordsQueryCount < recordsTotal) {
        text += " (" + filtersText + " " + recordsTotal + " " + totalRecordsText + ")";
      }
  ...
  function PaginationLinks(obj, settings) {
    ...
    this.create = function() {
      ...
      var pagesText = settings.inputs.pagesText;
      pageLinks += '<li><span>' + pagesText + '</span></li>';
